...
public class LevelManager : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI livesNumberText;
    ...
    public void GameStart()
    {
        ...
        livesLeft = livesMax;
        livesNumberText.text = livesLeft.ToString();
        LevelStart();
    }
